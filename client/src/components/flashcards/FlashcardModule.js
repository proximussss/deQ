...
const FlashcardModule = () => {
  ...
  const { cards, currentCard, currentIndex, loading } = useSelector(
    (state) => state.card,
  );
  ...
  const handleMarkCorrect = () => {
    ...
    dispatch(
      updateCard(moduleName, currentCard.id, {
        correct: "Correct",
        response: answer,
      }),
    );
  ...
  const handleResetScores = () => {
    if (
      window.confirm(
        "Are you sure you want to reset all scores? This will start a new session.",
      )
    ) {
    ...
    <FlashcardModuleContainer>
      <div className="module-header">
        ...
        <div className="header-controls">
          <div className="stats">
            <p>
              Progress: {stats.correct} / {stats.total} ({stats.percentage}%)
            </p>
          </div>
          <div className="header-buttons">
            <Link to="/sessions" className="logs-link">
              View Session Logs
            </Link>
            <button onClick={handleResetScores} className="reset-btn">
              Reset Scores
            </button>
            <Link to="/modules" className="module-switch">
              Switch Module
            </Link>
          </div>
        </div>
